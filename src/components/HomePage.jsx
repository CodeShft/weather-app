...
function HomePage() {
	...
	return (
		<div className="min-h-screen flex flex-col max-w-screen" data-theme="light">
          ...
          <h1 className="text-center text-5xl leading-relaxed text-black">{locationName}</h1>
          {currentWeather ? (
            ...
            <div className="card max-w-md lg:card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body">
                ...
                <p>Hava durumunu görüntülemek için konum izninin açık olması ya da arama kutucuğundan istediğiniz şehri yazmanız gerekmektedir.</p>
              </div>
            </div>
          )}
        </div>
